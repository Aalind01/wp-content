...
Elite Business includes support for Infinite Scroll in Jetpack, Breadcrunb NXT for advanced breadcrumb solution.

== Changelog ==

 = 1.1.3 - 23 December, 2022 =
 * Bug Fixed: Search page css issue
...
= 1.0.6 - 29 July, 2021 =
* Update: Added link to slider title (Props: adavis: ad9853@gmail.com)

= 1.0.5 - 24 July, 2021 =
* Update: Fontawesome to 5.15.3
* Update: Compatibility check with WP 5.8
* Update: Demo link
* Fix: Header media meta options not working( Props:platinumarts - mike@superherohill.com )

= 1.0.4 - 8 May, 2021 =
* Update: JS Migrate issue fix

= 1.0.3 - 8 Mar, 2021 =
* Fix: single page/post  and text widget link issues fixed
...
Images
	All images are licensed under [CC0] (https://creativecommons.org/publicdomain/zero/1.0/)
		* Screenshot and header image: https://stocksnap.io/photo/business-man-FCUDWWBKFV
										...
										https://stocksnap.io/photo/business-man-0EK6PQKCNT
