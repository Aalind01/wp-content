...
$elite_business_classes[] = 'wwd-section';
$elite_business_classes[] = 'section';
$elite_business_classes[] = 'page';
$elite_business_classes[] = elite_business_gtm( 'elite_business_wwd_style' );
?>

<div id="wwd-section" class="section wwd-section <?php elite_business_display_section_classes( $elite_business_classes ); ?>">
