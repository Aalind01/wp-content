 ...
 * Description:       The Lemmony Companion is a companion plugin for the Lemmony theme (coming soon). Adds additional block editor blocks needed for the best theme experience.
 * Version:           1.0.7
...
define( 'LEMMONY_COMPANION_VERSION', '1.0.7' );
