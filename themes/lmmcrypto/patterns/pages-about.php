...
<h2 class="wp-block-heading has-huge-font-size lemmony-animation" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;line-height:1.1;--lemmony-animation-name:lemmonyFadeInUp"><?php esc_html_e( 'The Story About Your Amazing Company', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="has-small-plus-font-size lemmony-animation" style="--lemmony-animation-name:lemmonyFadeInUp;animation-delay:var(--lemmony-delay-xsmall)"><?php esc_html_e( 'It\'s always wise to', 'lmm-crypto' ); ?><strong> <?php esc_html_e( 'add information in chunks.', 'lmm-crypto' ); ?></strong> <?php esc_html_e( 'That way your website users will find it easier to digest content on your site.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h3 class="wp-block-heading has-text-align-center has-small-font-size" style="line-height:1.4"><?php esc_html_e( 'Years of Experience', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<div style="line-height:1.3;text-align:center" class="wp-block-lemmony-companion-counter has-large-plus-font-size"><span class="lemmony-counter-wrapper" data-start="0" data-end="15" data-duration="3"><span class="lemmony-counter-number">0</span><span class="lemmony-counter-suffix"><?php esc_html_e( 'K+', 'lmm-crypto' ); ?></span></span></div>
<!-- /wp:lemmony-companion/counter -->

<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"small"} -->
<h3 class="wp-block-heading has-text-align-center has-small-font-size"><?php esc_html_e( 'Users Worldwide', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"small"} -->
<h3 class="wp-block-heading has-text-align-center has-small-font-size"><?php esc_html_e( 'Potential Growth', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h5 class="wp-block-heading lemmony-animation lemmonyFadeInUp has-small-font-size lemmony-animation" style="font-style:normal;font-weight:600;line-height:1.6;--lemmony-animation-name:lemmonyFadeInUp"><?php esc_html_e( 'The motivation', 'lmm-crypto' ); ?></h5>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading lemmony-animation lemmonyFadeInUp has-large-plus-font-size lemmony-animation" style="margin-top:var(--wp--preset--spacing--10);line-height:1.3;--lemmony-animation-name:lemmonyFadeInUp"><?php esc_html_e( 'Epic Company Value Proposition Block', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'Friendly community', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"tiny-plus"} -->
<p class="has-tiny-plus-font-size"><?php esc_html_e( 'Have a question? Now you can ask us using this handy-dandy email address.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:column {"width":"66.66%","style":{"spacing":{"blockGap":"var:preset|spacing|10"}}} -->
<div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:heading {"level":3,"fontSize":"small-plus"} -->
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'Theme feature', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"tiny-plus"} -->
<p class="has-tiny-plus-font-size"><?php esc_html_e( 'Show the steps required for growth, the less the easier on the eye.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:column --></div>
...
<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Products &amp; Services', 'lmm-crypto' ); ?> </h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-medium-plus-font-size" style="margin-top:40px"><?php esc_html_e( 'Service One', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small-plus"} -->
<p class="has-small-plus-font-size"><?php esc_html_e( 'Make a pleasant visual experience for your website visitors. Try to keep your ideas and design in balance.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size lemmony-button-hover-primary-text has-tiny-plus-font-size" style="font-style:normal;font-weight:700"><a class="wp-block-button__link has-body-color has-white-background-color has-text-color has-background wp-element-button" href="#" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php esc_html_e( 'Example button', 'lmm-crypto' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<!-- wp:heading {"style":{"spacing":{"margin":{"top":"40px"}}},"fontSize":"medium-plus"} -->
<h2 class="wp-block-heading has-medium-plus-font-size" style="margin-top:40px"><?php esc_html_e( 'Awesome Product', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small-plus"} -->
<p class="has-small-plus-font-size"><?php esc_html_e( 'Don’t shy away from using this helpful block to guide your website users to useful pages.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Search Engine Optimization', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'A short explanation about the service you can offer your future clients.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button has-custom-font-size has-tiny-font-size"><a class="wp-block-button__link wp-element-button" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--40)"><?php esc_html_e( 'More', 'lmm-crypto' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"blockGap":"var:preset|spacing|10"}}} -->
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"large"} -->
<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Website Design', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"blockGap":"var:preset|spacing|10"}}} -->
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"large"} -->
<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Branding', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center has-large-plus-font-size"><?php esc_html_e( 'Check the Most Important Features', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"small-plus"} -->
<p class="has-text-align-center has-small-plus-font-size"><?php esc_html_e( 'The more you tell about your service or project, the easier your client\'s decision will be!', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading has-small-plus-font-size" style="margin-top:var(--wp--preset--spacing--30);font-style:normal;font-weight:700;line-height:1.4"><?php esc_html_e( 'Friendly support', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"fontSize":"tiny-plus","animationStyle":""} -->
<p class="has-tiny-plus-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php esc_html_e( 'Don’t shy away from using this helpful block to guide your website users to useful pages.', 'lmm-crypto' ); ?> </p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size lemmony-button-hover-primary-text has-tiny-plus-font-size" style="font-style:normal;font-weight:700"><a class="wp-block-button__link has-body-color has-transparent-background-color has-text-color has-background wp-element-button" href="#" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php esc_html_e( 'Example button', 'lmm-crypto' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<h3 class="wp-block-heading has-small-plus-font-size" style="margin-top:var(--wp--preset--spacing--30);font-style:normal;font-weight:700;line-height:1.4"><?php esc_html_e( 'Made with love', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"fontSize":"tiny-plus"} -->
<p class="has-tiny-plus-font-size" style="margin-top:var(--wp--preset--spacing--20)"><?php esc_html_e( 'Make a pleasant visual experience for your website visitors. Try to keep your ideas and design in balance.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","lineHeight":"1.4"},"spacing":{"margin":{"top":"var:preset|spacing|30"}}},"fontSize":"small-plus"} -->
<h3 class="wp-block-heading has-small-plus-font-size" style="margin-top:var(--wp--preset--spacing--30);font-style:normal;font-weight:700;line-height:1.4"><?php esc_html_e( 'Infinity animations', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading"><?php esc_html_e( 'Check the Most Important Features', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Explore site', 'lmm-crypto' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-lemmony-companion-accordion is-open"><div class="lemmony-accordion-container"><h2 class="lemmony-accordion-title"><?php esc_html_e( 'How many patterns does this theme have?', 'lmm-crypto' ); ?></h2><div class="lemmony-accordion-content"><!-- wp:paragraph -->
...
<div class="wp-block-lemmony-companion-accordion"><div class="lemmony-accordion-container"><h2 class="lemmony-accordion-title"><?php esc_html_e( 'Is Lemmony WordPress theme free to use?', 'lmm-crypto' ); ?></h2><div class="lemmony-accordion-content"><!-- wp:paragraph -->
<p><?php esc_html_e( 'Don’t shy away from using this helpful block to guide your website users to useful pages. Be the guide that they deserve!', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph --></div></div><div class="lemmony-accordion-icon"></div></div>
<!-- /wp:lemmony-companion/accordion -->
...
<h2 class="wp-block-heading has-text-align-center has-huge-font-size"><?php esc_html_e( 'Grow Your Business With Us', 'lmm-crypto' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"medium"} -->
<p class="has-text-align-center has-medium-font-size"><?php esc_html_e( 'Next level solutions with Lemmony Agency', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph -->
