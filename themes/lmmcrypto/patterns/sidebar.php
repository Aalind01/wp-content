...
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'Can\'t find something?', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-group has-midground-background-color has-background" style="border-radius:10px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"level":3,"fontSize":"small-plus"} -->
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'About The Author', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:image {"id":3008,"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"24px"}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri("assets/media/content/sidebar-author.jpg") ); ?>" alt="" class="wp-image-3008" style="border-radius:24px"/></figure>
<!-- /wp:image -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.8"}},"fontSize":"small"} -->
<p class="has-small-font-size" style="line-height:1.8"><strong><?php esc_html_e( 'As far as I can remember', 'lmm-crypto' ); ?></strong> <?php esc_html_e( 'Lemons always helped me to stay motivated, especially when I applied two slices on my eyes. A blog author should always carry an small hammer at all times. It\'s an au-thor thing, trust me.', 'lmm-crypto' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50","top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}},"border":{"radius":"10px"}},"backgroundColor":"midground","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-midground-background-color has-background" style="border-radius:10px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"level":3,"fontSize":"small-plus"} -->
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'Fresh Articles', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-column" style="flex-basis:80px"><!-- wp:group {"style":{"border":{"radius":"12px"}},"className":"lemmony-aspect-1_1 has-background-background-color","layout":{"type":"constrained"}} -->
<div class="wp-block-group lemmony-aspect-1_1 has-background-background-color" style="border-radius:12px"><!-- wp:post-featured-image {"isLink":true,"width":"80px","height":"80px","sizeSlug":"thumbnail","align":"wide","style":{"border":{"radius":"12px"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50","top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}},"border":{"radius":"10px"}},"backgroundColor":"midground","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-midground-background-color has-background" style="border-radius:10px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"level":3,"fontSize":"small-plus"} -->
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'Keep it social', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50","top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}},"border":{"radius":"10px"}},"backgroundColor":"midground","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-midground-background-color has-background" style="border-radius:10px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"level":3,"fontSize":"small-plus"} -->
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'Categories', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50","top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}},"border":{"radius":"10px"}},"backgroundColor":"midground","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-midground-background-color has-background" style="border-radius:10px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"level":3,"fontSize":"small-plus"} -->
<h3 class="wp-block-heading has-small-plus-font-size"><?php esc_html_e( 'Tags', 'lmm-crypto' ); ?></h3>
<!-- /wp:heading -->
